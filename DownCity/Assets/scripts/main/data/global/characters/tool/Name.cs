...
namespace GST.CharaSpace {
    public class NameCreator {
        ...
        public string GetSurname() {
            int idx = NameConst.surnameWeight.GetRandomWithPower();
            List<string> surnames = NameConst.surname[idx];
            List<int> weight = new List<int>();
            for (var i = 0; i < surnames.Count; i++) {
                weight.Add(surnames.Count + 1 - i);
            }
            //Random random = new Random();
            //int index = random.Next(0, surnames.Count);
            return surnames[weight.GetRandomWithPower()];
        }
        ...
        // Private Properties
        //======================================================================
        private object[] CreateRegionCode(int strlength, bool isRandomCount = false) {
            if (isRandomCount) {
                Random random = new Random();
