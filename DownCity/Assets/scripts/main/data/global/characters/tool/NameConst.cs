...
namespace GST.CharaSpace {
    public static class NameConst {
        ...
        /// 姓名权重比
        /// </summary>
        public static List<int> surnameWeight = new List<int>{ 100, 70, 10, 5, 1, 1 };
        /// <summary>
        /// The surname.
        /// </summary>
        public static List<List<string>> surname = new List<List<string>> {
        new List<string>{"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫",
        ...
        new List<string>{"郁", "单", "杭", "洪", "包", "诸", "左", "石", "崔", "吉", "钮", "龚",
        ...
        new List<string>{"欧", "殳", "沃", "利", "蔚", "越", "夔", "隆", "师", "巩", "厍", "聂",
        ...
        new List<string>{"求", "羽", "用", "占", "真", "穰", "翦", "闾", "漆", "贵", "代", "贯",
        ...
        new List<string>{"同", "蚁", "止", "戢", "睢", "冼", "种", "涂", "肖", "己", "泣", "潜",
        ...
        new List<string>{"五", "令", "将", "旗", "军", "行", "奉", "敬", "恭", "仪", "母", "堂",
